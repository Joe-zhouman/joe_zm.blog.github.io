...
![]({{site.url}}/_post/Python/autoConnector/ac1.png)

2. 进入`network`选项卡，并勾选`Preserve log`选项

![]({{site.url}}/_post/Python/autoConnector/ac2.png)
...
![]({{site.url}}/_post/Python/autoConnector/header.png)
...
```
如我的
![bat]({{site.url}}/_post/Python/autoConnector/bat.png)
在windows的`任务计划程序`中新建一个定时启动的任务,按下图设置:
![计划任务设置-常规]({{site.url}}/_post/Python/autoConnector/TimerGeneral.png)
![计划任务设置-触发器]({{site.url}}/_post/Python/autoConnector/TimerTrigger.png)
![计划任务设置-操作]({{site.url}}/_post/Python/autoConnector/TimerTrigger.png)
...
![]({{site.url}}/_post/Python/autoConnector/get.png)
